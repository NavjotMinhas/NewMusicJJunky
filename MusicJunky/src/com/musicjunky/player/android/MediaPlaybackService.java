...
public class MediaPlaybackService extends Service {
    ...
    private Handler mMediaplayerHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            Log.e(TAG,"mMediaplayerHandler.handleMessage " + msg.what);
            switch (msg.what) {
                case FADEDOWN:
                    mCurrentVolume -= .05f;
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.e(TAG,"mIntentReceiver.onReceive " + action + " / " + cmd);
            ...
            /**
             * Some widget stuff that I should implment when I make the music junky widget
             */
...
//        mRemoteControlClient.setTransportControlFlags(flags);
        ...
        mCardId = MediaPlaybackService.getCardId(this);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            String action = intent.getAction();
            String cmd = intent.getStringExtra("command");
            Log.e(TAG,"onStartCommand " + action + " / " + cmd);
            ...
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                        ...
                        mMediaMountedCount++;
                        mCardId = MediaPlaybackService.getCardId(MediaPlaybackService.this);
                        reloadQueue();
...
//            ed.apply();
        ...
        /**
         * Enable this when we have a musicjunky widget
         */
        /**
        ...
        synchronized (this) {
            ...
            while(true) {
                ...
                if (mOpenFailedCounter++ < 10 &&  mPlayListLen > 1) {
                    ...
                    if (!mQuietMode) {
                        Toast.makeText(this, "The player doesn't support this type of audio file.", Toast.LENGTH_SHORT).show();
                    }
    ...
    public void play() {
        ...
        /**
         * 
         * Enable this for music junky later
         * 
    ...
    private void updateNotification() {
    	/**
    	 * I need to add this to musicjunky later
    	 */
    ...
    protected void dump(FileDescriptor fd, PrintWriter writer, String[] args) {
        Log.d(TAG,"" + mPlayListLen + " items in queue, currently at index " + mPlayPos);
        Log.d(TAG,"Currently loaded:");
        Log.d(TAG,getArtistName());
        Log.d(TAG,getAlbumName());
        Log.d(TAG,getTrackName());
        Log.d(TAG,getPath());
        Log.d(TAG,"playing: " + mIsSupposedToBePlaying);
        Log.d(TAG,"actual: " + mPlayer.mCurrentMediaPlayer.isPlaying());
        Log.d(TAG,"shuffle mode: " + mShuffleMode);
    }
